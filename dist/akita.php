...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">秋田県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、秋田県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
  
    <div id="ramen-shop-list">
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="#"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/bsNr2p7Jax4/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">ラーメン マシンガン</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="#"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/CSLzXt-tsJU/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">自家製麺 佐藤</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="#"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/tH0RR5g936A/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">麺屋にぼすけ大曲駅前店</h3>
        </div>
    </div>
    </div>
  ...
  //秋田
  //39.45948818193276, 140.48017742722516
  var get_param_lat = 39.4594;
  var get_param_lng = 140.4801;
