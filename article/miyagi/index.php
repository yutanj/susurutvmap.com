...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">宮城県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、宮城県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
    ...
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=JOvG1QHWVXg"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/JOvG1QHWVXg/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">ピーコック  </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=Ua0ZcT8cE9g"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/Ua0ZcT8cE9g/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">本竈 </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=D8YpyyTd06s"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/D8YpyyTd06s/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">だし廊 </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=ZcJ9KvKHsEE"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/ZcJ9KvKHsEE/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">みずさわ屋 </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=0RwJ8gA-izE"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/0RwJ8gA-izE/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">中華そば嘉一 </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=-bdkEsfBtiA"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/-bdkEsfBtiA/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">麺組  </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=v6SR20T-q6c"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/v6SR20T-q6c/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">杉のや </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=hRzP7WKyQNk"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/hRzP7WKyQNk/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">くろく </h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=4x3RCLHNExM"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/4x3RCLHNExM/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">自家製太麺 渡辺  </h3>
        </div>
    </div>  
  ...
  var get_param_lat = 38.381565;
  var get_param_lng = 140.941651;
