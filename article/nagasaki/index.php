...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">長崎県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、長崎県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
    ...
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=3o_SZF3N-tE"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/3o_SZF3N-tE/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">柊 本店</h3>
        </div>
    </div>
  ...
  var get_param_lat = 32.955619;
  var get_param_lng = 129.715641;
