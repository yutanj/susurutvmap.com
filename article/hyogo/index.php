...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">兵庫県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、兵庫のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
  
    <div id="ramen-shop-list">
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=EgIar8LsiRU"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/EgIar8LsiRU/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">丸高中華そば 神戸二宮店</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=IvL3v3BxDts"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/IvL3v3BxDts/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">ラーメンたんろん本店</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=RAD5U8tGHs4"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/RAD5U8tGHs4/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">ぶたのほし</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=oN6wim6mQ40"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/oN6wim6mQ40/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">ラーメンたろう トアロード店</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=LvQX0JybVEY"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/LvQX0JybVEY/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">神戸ちぇりー亭 六甲道店</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=1znl5DEYudE"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/1znl5DEYudE/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">らーめん専門 和海</h3>
        </div>
    </div>
  ...
  var get_param_lat = 35.068625;
  var get_param_lng = 134.794436;
