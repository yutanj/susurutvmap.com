...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">広島県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、広島県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
  
    <div id="ramen-shop-list">
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=OLgO8UkO1fY"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/OLgO8UkO1fY/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">めん処みやち</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=1n2UqT5XuxI"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/1n2UqT5XuxI/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">尾道ラーメン丸ぼし</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=HpEB-5F9vtI"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/HpEB-5F9vtI/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">壱番館</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=d_YINy_ROYY"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/d_YINy_ROYY/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">面館 </h3>
        </div>
    </div>
  ...
  //秋田
  //34.59173332705918, 132.7990513571538
  var get_param_lat = 34.591733;
  var get_param_lng = 132.7990;
