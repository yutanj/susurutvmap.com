...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">岐阜県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、岐阜県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
  
    <div id="ramen-shop-list">
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=EypzZifL65c"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/EypzZifL65c/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">元祖 タンメン屋 岐阜本店</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=_hrTO7Img6c"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/_hrTO7Img6c/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">あらき軒</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=3LhuEAnt93k"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/3LhuEAnt93k/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">りきどう</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=zFL_G6t0TQo"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/zFL_G6t0TQo/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">丸デブ総本店</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=_7HTrQcOrKw"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/_7HTrQcOrKw/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">元祖タンメン屋岐阜本店</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=n9Qvl27WEFg"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/n9Qvl27WEFg/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">麺屋白神</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=QgDI9gypkME"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/QgDI9gypkME/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">二代目白神</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=INvHrrLTMig"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/INvHrrLTMig/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">ラーメンイロドリ</h3>
        </div>
    </div>
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=WzsKxWl36co"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/WzsKxWl36co/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">稲葉家</h3>
        </div>
    </div>
  ...
  //秋田
  //35.763363446768345, 137.0248576354487
  var get_param_lat = 35.7633634;
  var get_param_lng = 137.024857;
