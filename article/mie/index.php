...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">三重県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、三重県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
    ...
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=HvBRtqJOMY4"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/HvBRtqJOMY4/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">そにどり </h3>
        </div>
    </div> 
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=yc2mL9gXFjQ"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/yc2mL9gXFjQ/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">鉢ノ葦葉 </h3>
        </div>
    </div> 
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=ZSKg8WJfBUM"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/ZSKg8WJfBUM/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">麺や 暁 </h3>
        </div>
    </div> 
  ...
  var get_param_lat = 34.484291;
  var get_param_lng = 136.432514;
