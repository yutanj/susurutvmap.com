...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">高知県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、高知県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
    ...
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=wnapkcGF7ac"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/wnapkcGF7ac/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">鍋焼きラーメン千秋</h3>
        </div>
    </div> 
  ...
  var get_param_lat = 33.50708;
  var get_param_lng = 133.364174;
