...
<head>
  <meta charset="UTF-8">
  <title>鹿児島県 | SUSURU TV. map</title>
...
<body class="font-sans h-full">
  ...
  <h1 class="font-bold text-2xl pb-4">鹿児島県のラーメン</h1>
  ...
  <h2 class="text-lg">SUSURU TV.で紹介された、鹿児島県のラーメン店をまとめています。お店選びの参考に参考にしてみてください。（サムネイルをクリックすると動画が見れます）</p>
    ...
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=ogyNp36_vU4"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/ogyNp36_vU4/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">とくだラーメン</h3>
        </div>
    </div> 
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=zvhIVFAjK50"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/zvhIVFAjK50/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">くろいわラーメン本店</h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=auJt2eQtOQc"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/auJt2eQtOQc/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">鹿児島ラーメン豚とろ 天文館本店</h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=FdCtlbuR-VI"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/FdCtlbuR-VI/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">そばる</h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=_8_Cz8xeEtc"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/_8_Cz8xeEtc/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">ラーメン小金太</h3>
        </div>
    </div>  
    <div class="border-b-2">
        <div class="flex my-5">
            <a href="https://www.youtube.com/watch?v=529zOe8Fv78"><img class="w-36 h-auto pt-2 pr-4 md:w-58 h-auto pr-4" src="http://img.youtube.com/vi/529zOe8Fv78/mqdefault.jpg" alt=""></a>
            <h3 class="font-bold">麺屋ばってん　親父</h3>
        </div>
    </div>   
  ...
  var get_param_lat = 31.355836;
  var get_param_lng = 130.410976;
